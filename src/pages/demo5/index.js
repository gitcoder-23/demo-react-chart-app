...
export const graphDaraExample = [
  ...
  {
    month_date: "2025-04-01", // Note: This month_date is duplicated in the provided data
    shpm_sp: 39282796.25,
    bop_sum_sp: 40031982.25,
    sp: "100.80%",
  },
];
...
const chartData = graphDaraExample.map((item) => ({
  ...
  BOP: item.bop_sum_sp / 1000,
  SH: item.shpm_sp / 1000,
  // Parse SP percentage string to a number
  SP: parseSp(item.sp),
}));
...
export default DemoChartNewApp;
